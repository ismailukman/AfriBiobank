          ...
          >
            ...
            <div className="px-4 pt-4 pb-2">
              <button
                ...
                className="w-full flex items-center justify-between rounded-2xl border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-50 transition"
              >
              ...
              <AnimatePresence>
                {showSpec ? (
                  <motion.div
                    ...
                    className="mt-3 space-y-3 text-xs text-slate-600"
                  >
            ...
            <div className="px-4 pb-3 space-y-3">
              <div className="h-64 overflow-y-auto pr-1 space-y-3">
                ...
                {isTyping ? (
                  <div className="flex justify-start">
                    <div className="rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-500 flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-2">
                {quickReplies.map((reply) => (
                  <button
                    ...
                    className="rounded-full border border-slate-200 px-3 py-1 text-[11px] font-semibold text-slate-600 hover:bg-slate-100 transition"
                  >
                    {reply.label}
                  </button>
                ))}
              ...
              <div className="zuri-audio-bar flex items-center justify-between rounded-2xl border border-slate-200 px-3 py-2 text-[11px] text-slate-500">
